...
const Upload = () => {
  ...
  // const dispatch = useDispatch()
    ...
    const handleSubmit = (e) =>{
        ...
        createNewsPost({title,content,username},dispatch)
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex h-screen bg-gray-200 items-center  justify-center ">
          <div className="grid bg-white-600 rounded-lg shadow-xl w-10/12">
            ...
            <div className="grid grid-cols-1 mt-5 mx-7">
              <textarea
                className=" py-4 px-3 rounded-lg border-2 bg-gray-200 h-36 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                type="text"
